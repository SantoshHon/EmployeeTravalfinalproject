...
public class TravlingRequestDetailsRepository implements TravlingRequestDetailsRepositoryInterface{
	...
	private static final String INSERT_TravellingRequestDetails = " INSERT INTO travelling_request_details(TRAVEL_DEPARTURE_DATE,TRAVEL_RETURN_DATE,TRAVEL_REASON ,TRAVEL_MODE ,TRAVEL_STATUS ,PROJECT_MANAGER_STATUS ,DIRECTOR_STATUS ,TRAVEL_LOCATIONEMPLOYEE_ID ,TRAVEL_DETAILS_ID , DOCUMENT_ID )VALUES (?,?,?,?,?,?,?,?,?,?,?)";
